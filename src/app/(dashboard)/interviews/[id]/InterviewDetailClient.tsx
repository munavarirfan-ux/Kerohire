            ...
            <CardContent>
              <div className="flex gap-2 mb-2">
                <button
                  ...
                  className={`px-3 py-1 rounded-lg text-sm ${translateLang === "en" ? "bg-primary text-white" : "bg-secondary-fill"}`}
                >
                  EN
                </button>
                <button
                  ...
                  className={`px-3 py-1 rounded-lg text-sm ${translateLang === "de" ? "bg-primary text-white" : "bg-secondary-fill"}`}
                >
                  DE
                </button>
              </div>
